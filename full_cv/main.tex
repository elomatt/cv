...
Achievements:
\begin{itemize}[leftmargin=1cm]
	\item Outfitted an optics bench from scratch.
...
\textbf{First Class Honours} My Masters thesis explored technologies for improving magnetic imaging techniques following a year apent living and studying at the Universit\'e de Rennes 1.
Achievements:
\begin{itemize}[leftmargin=1cm]
